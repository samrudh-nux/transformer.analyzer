...
**[Live Demo](https://transformer-analyzer.vercel.app)** *NOTE : after new user sign up, you would get mail confrimation link (click on that ) and manually need to come back to page you would be on sign up page again enter password and unlock other two features , BYE*
